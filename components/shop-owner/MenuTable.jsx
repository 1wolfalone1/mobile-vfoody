      ...
      <ScrollView>
        <DataTable>
          <DataTable.Header className="bg-gray-200">
            <DataTable.Title className="flex-1">Name</DataTable.Title>
            <DataTable.Title numeric className="flex-1 mr-9" sortDirection="descending">
              Price
            </DataTable.Title>
            <DataTable.Title numeric className="flex-1"></DataTable.Title>
          </DataTable.Header>
            ...
            <DataTable.Row key={item.id} className="flex-row">
              ...
              <DataTable.Cell numeric className="flex-1">
                <View className="flex-row items-center gap-1">
                  ...
                  <Text className="text-slate-500 text-[10px]">VND</Text>
                </View>
              </DataTable.Cell>
              <DataTable.Cell numeric className="flex-1">
                <View className="flex-row gap-3">
                  <Pencil color="#DF4830" size={20} />
                  <Trash2 color="#DF4830" size={20} onPress={showDeleteDiaglog} />
                </View>
              </DataTable.Cell>
            </DataTable.Row>
          ))}
